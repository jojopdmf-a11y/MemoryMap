...
Vite binds **0.0.0.0:43123** (`strictPort`). Open that URL, pick a sample trip under `public/` (for example `disney-toy-story-usa.csv`), plot it, and use Play. Guest download stays free while Paddle is sandbox.
